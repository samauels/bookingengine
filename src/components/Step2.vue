<template>
  <div>
    ...
    >
      ...
      <div class="row">
        <div class="col-md-6">
          <b-form-group label="Street:" label-for="input-2">
            <b-form-input
              v-model="form.street"
              required
        ...
        <div class="col-md-6">
          <b-form-group label="ZIP:" label-for="input-2">
            <b-form-input
              v-model="form.zip"
              required
      ...
      <div class="row">
        <div class="col-md-6">
          <b-form-group label="City:" label-for="input-2">
            <b-form-input
              v-model="form.city"
              required
      ...
      <b-button type="submit" hidden ref="detailsFormSubmit" variant="primary"
        >Submit</b-button
      >
    </b-form>
  </div>
...
export default {
  data() {
    return {
      ...
      countries: [
        ...
        { value: "Ceuta & Melilla", text: "Ceuta & Melilla" },
        ...
        { value: "Hong Kong SAR China", text: "Hong Kong SAR China" },
        ...
        { value: "Macao SAR China", text: "Macao SAR China" },
        ...
        { value: "Pseudo-Accents", text: "Pseudo-Accents" },
        { value: "Pseudo-Bidi", text: "Pseudo-Bidi" },
        ...
        { value: "São Tomé & Príncipe", text: "São Tomé & Príncipe" },
        ...
        { value: "Svalbard & Jan Mayen", text: "Svalbard & Jan Mayen" },
        ...
        { value: "U.S. Outlying Islands", text: "U.S. Outlying Islands" },
        ...
        { value: "Wallis & Futuna", text: "Wallis & Futuna" },
  ...
  methods: {
    ...
    validateData() {
      debugger;
      this.$refs.detailsFormSubmit.click();
    }
  }
};
</script>
